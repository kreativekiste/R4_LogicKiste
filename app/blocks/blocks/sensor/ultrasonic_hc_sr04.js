...
Blockly.defineBlocksWithJsonArray([
    {
        ...
        "args0": [
            ...
            { "type": "field_number", "name": "INTERVAL", "value": 60, "min": 30, "max": 5000 }
        ],
        "output": "Number",
        "colour": 45,
...
ArduinoGenerator.hardwareScanners['read_ultrasonic'] = function(block) {
    ...
    // Eindeutiger Name pro Pin-Kombination (mehrere Sensoren möglich)
    ...
    // Hilfsfunktion + millis-State pro Sensor-Instanz (einmalig)
