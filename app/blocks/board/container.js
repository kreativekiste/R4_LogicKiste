// ==========================================
// BAUTEIL: STRUKTUR-CONTAINER (Gruppieren & Kopieren)
// ==========================================
...
CONTAINER_COLORS.forEach(item => {
    const blockType = 'ard_container_' + item.id;
    ...
    Blockly.Blocks[blockType] = {
        init: function() {
            ...
            this.setTooltip("Dient zum Gruppieren von Blöcken zum einfachen Kopieren. Hat keinen Einfluss auf den C++ Code.");
        }
    };

    // --- GENERATOR LOGIK ---
    // Der Block selbst erzeugt keinen eigenen C++ Code. 
    // Er reicht einfach nur den Code aller Blöcke durch, die in ihn hineingesteckt werden.
    ArduinoGenerator.forBlock[blockType] = function(block) {
